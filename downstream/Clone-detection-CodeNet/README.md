...
Java250 consists of 250 problems,
where each includes 300 Java programs.
Therefore, R=299 in this task (1 query, 299 results).

## Dataset

We use [Java250](https://github.com/IBM/Project_CodeNet) dataset on this task.

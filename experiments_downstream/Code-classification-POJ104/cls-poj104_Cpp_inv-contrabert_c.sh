...
./run.sh "$ROOT_DIR/saved_models/InvContraBERT_C-supcon/final" "$ROOT_DIR/results/inv-contrabert_c/Code-classification-POJ104" Cpp roberta microsoft/codebert-base

...
from cpp_transforms.transformations.cursor_util import is_while


def while_for_reverser(root_node: Cursor, file_code: str) -> str:
    return while_for_reverse(root_node, "example.cpp", file_code, (0, len(file_code)))


def while_for_reverse(
    ...
    while len(to_visit) > 0:
        ...
        if is_while(curr_visit) and source_file in str(curr_visit.location):
